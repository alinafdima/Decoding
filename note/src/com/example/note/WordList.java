...
public class WordList extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button addnote = (Button)findViewById(R.id.addwordbutton);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent i = new Intent(this, WordEdit.class);
        i.putExtra(WordsDbAdapter.KEY_ROWID, id);
        startActivityForResult(i, ACTIVITY_EDIT);
    }

	private void fillData() {
        // Get all of the notes from the database and create the item list
        Cursor notesCursor = mDbHelper.fetchAllWords();
        startManagingCursor(notesCursor);
        

        String[] from = new String[] { WordsDbAdapter.KEY_TITLE ,WordsDbAdapter.KEY_DATE};
